        ...
        <>
            <nav className="flex items-center justify-between px-4 sm:px-6 py-4 max-w-7xl mx-auto w-full relative z-50">
                ...
                <div className="flex items-center gap-2">
                    <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-[#a87532] to-[#a87532] rounded-lg flex items-center justify-center overflow-hidden shadow-sm">
...
<div className={`fixed top-0 right-0 h-full w-72 bg-white/95 backdrop-blur-xl shadow-[0_20px_60px_rgba(0_0_0_0.15)] z-50 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
    ...
    <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-gradient-to-br from-[#a87532] to-[#a87532] rounded-lg flex items-center justify-center shadow-md">
    ...
    <div className="absolute bottom-0 left-0 w-full px-5 pb-6">
        <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-5 shadow-sm">
            ...
            <div className="flex flex-col gap-3">
                ...
                <button className="w-full bg-gradient-to-r from-[#a87532] to-[#a87532] text-white py-3 rounded-xl font-semibold shadow-lg hover:opacity-95 transition">
                    Get Started Free
                </button>
            </div>
        </div>
