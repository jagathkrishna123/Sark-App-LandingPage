...
//             <div className="absolute top-1/2 left-[70%] -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-blue-100 via-indigo-50 to-purple-50 rounded-full blur-[100px] opacity-60 -z-10"></div>

//             <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
//                 {/* Left Content */}
//                 <div>
//                     <h1 className="text-6xl font-bold text-[#111827] leading-[1.3] mb-6">
...
//                         <button className="bg-[#7c3aed] text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-purple-200 hover:bg-[#6d28d9] transition-all">
//                             Let's get started
//                         </button>
//                         <button className="flex items-center gap-3 bg-white border border-gray-100 px-8 py-4 rounded-xl font-bold text-gray-900 hover:bg-gray-50 transition-all shadow-sm">
...
//                     <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[500px] bg-yellow-200/40 rounded-full blur-[80px] -z-10"></div>

//                     <div className="relative mx-auto w-[320px] h-[650px] bg-black rounded-[45px] p-3 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border-[8px] border-gray-800">
//                         {/* Screen Content */}
//                         <div className="w-full h-full bg-white rounded-[35px] overflow-hidden relative font-sans">
//                             {/* Status Bar */}
//                             <div className="pt-8 px-6 flex justify-between items-center text-[10px] font-bold">
//                                 <span>9:41</span>
//                                 <div className="flex gap-1.5">
//                                     <div className="w-3.5 h-3.5 flex items-center justify-center">
//                                         <svg viewBox="0 0 24 24" className="w-full h-full"><path d="M12 21L2 11h20L12 21z" /></svg>
//                                     </div>
//                                     <div className="w-3.5 h-3.5 flex items-center justify-center">
//                                         <svg viewBox="0 0 24 24" className="w-full h-full"><path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z" /></svg>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                 <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-lg transform rotate-45 flex items-center justify-center">
...
//                                     ))}
//                                 </div>
//                                 <div className="flex justify-between mt-1 text-[6px] text-gray-400 uppercase font-bold tracking-widest">
//                                     <span>Sun</span>
//                                     <span>Mon</span>
//                                     <span>Tue</span>
//                                     <span>Wed</span>
...
//                             <div className="px-6 mt-8">
//                                 <h4 className="text-[12px] font-bold text-gray-900">Business Ranking</h4>
//                             </div>

//                             {/* Recent Activity Mockup */}
//                             <div className="px-6 mt-6">
//                                 <h5 className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-4">Recent Activity</h5>
...
//                                             <div className={`w-6 h-6 rounded-lg ${item.color} flex-shrink-0 flex items-center justify-center`}>
//                                                 <div className="w-2 h-2 bg-white/30 rounded-full"></div>
//                                             </div>
//                                             <div>
//                                                 <p className="text-[10px] leading-tight"><span className="font-bold text-gray-900">{item.name}</span> <span className="text-gray-500">{item.text}</span></p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                ...
                <div className="text-center lg:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                        <button className="w-full sm:w-auto bg-[#7c3aed] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold shadow-lg shadow-purple-200 hover:bg-[#6d28d9] transition-all">
                            Let's get started
                        </button>
                ...
                <div className="relative flex justify-center">
                    {/* Subtle Glow behind phone */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[450px] lg:w-[500px] h-[350px] sm:h-[450px] lg:h-[500px] bg-gradient-to-tr from-blue-400/40 via-indigo-500/40 to-purple-400/40 rounded-full blur-[80px] sm:blur-[100px] lg:blur-[120px] opacity-80 z-0"></div>
